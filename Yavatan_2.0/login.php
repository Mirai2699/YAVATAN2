...
<head>
    ...
    <!-- global level css -->
    <link href="resources/parallax/css/bootstrap.min.css" rel="stylesheet" />
    <!-- end of global level css -->
    <!-- page level css -->
    <link href="resources/parallax/css/pages/login2.css" rel="stylesheet" />
    <link href="resources/parallax/vendors/iCheck/skins/minimal/blue.css" rel="stylesheet" />
...
<body>
            ...
            <div class=" col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3  col-md-5 col-md-offset-4 col-lg-4 col-lg-offset-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                         <img src="resources/parallax/assets/logo/[LIGHT] Yavatan_04.png"  alt="YAVATAN" style="width:100%"  /> 
                    </div>
    ...
    <!-- global js -->
    <script src="resources/parallax/js/jquery-1.11.1.min.js" type="text/javascript"></script>
    <script src="resources/parallax/js/bootstrap.min.js" type="text/javascript"></script>
    <!--livicons-->
    <script src="resources/parallax/vendors/livicons/minified/raphael-min.js" type="text/javascript"></script>
    <script src="resources/parallax/vendors/livicons/minified/livicons-1.4.min.js" type="text/javascript"></script>
    <!-- end of global js -->
    <!-- begining of page level js-->
    <script src="resources/parallax/js/TweenLite.min.js"></script>
    <script src="resources/parallax/vendors/iCheck/icheck.js" type="text/javascript"></script>
...
<script src="resources/parallax/hc/code/highcharts.js"></script>
<script src="resources/parallax/hc/code/highcharts-more.js"></script>
