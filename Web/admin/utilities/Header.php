                            ...
                            <?php  
                                   ...
                                   while ($row = mysqli_fetch_array($result)) 
                                   {
                                    $pic = $row['acc_picture'];
                                     ...
                                     if($pic != NULL)
                                     {
                                         echo '<img src="../../../Yavatan_Profiles/'.$pic.'" width="35" class="img-circle img-responsive pull-left" height="35" alt="">';
                                     }
                                     else if ($pic == NULL)
                                ...
                                <?php  
                                   ...
                                   while ($row = mysqli_fetch_array($result)) 
                                   {
                                    $pic = $row['acc_picture'];
                                     ...
                                     if($pic != NULL)
                                     {
                                         echo '<img src="../../../Yavatan_Profiles/'.$pic.'" class="img-responsive img-circle" alt="">';
                                     }
                                     else if ($pic == NULL)
