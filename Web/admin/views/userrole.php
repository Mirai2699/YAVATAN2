                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12 text-right">
                                                <button type="submit" name="adduserrole" class="btn btn-responsive btn-info btn-sm" style="font-size: 16px">
                        ...
                        <div class="panel panel-success filterable" >
                            ...
                            <div class="panel-body">
                                <table class="table table-striped table-responsive" id="table1">
                                    ...
                                    <tbody>
                                    <?php
                                        $view_query = mysqli_query($connection,"SELECT * FROM `r_user_role` WHERE usr_stat = 1");
                                ...
                                <div class="modal-body" style="height:160px;">
                                    <form action="../functionalities/update_func.php" method="POST">
                                        ...
                                        <div class="col-md-12">
                                              ...
                                              <input type="text" class="form-control" name="usr_name" value="<?php echo $Name?>" style="width: 70%">
                                              <br>
                                              <button type="submit" name="editusr" class="btn btn-success" style="font-size: 15px">
                                ...
                                <div class="modal-body" style="height:180px;">
                                    <form action="../functionalities/archive_func.php" method="POST">
                                        ...
                                        <div class="col-md-12">
                                              ...
                                              <button type="submit" name="arch_usr" class="btn btn-success" style="font-size: 25px">
