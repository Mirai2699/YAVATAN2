                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12 text-right">
                                                <button type="submit" name="addeveaud" class="btn btn-responsive btn-info btn-sm" style="font-size: 16px">
                        ...
                        <div class="panel panel-success filterable" >
                            ...
                            <div class="panel-body">
                                <table class="table table-striped table-responsive" id="table1">
                                    ...
                                    <tbody>
                                    <?php
                                        $view_query = mysqli_query($connection,"SELECT * FROM `r_event_audience` WHERE ev_aud_stat = 1");
                            ...
                            <center>
                                ...
                                <div class="modal-body" style="height:160px;">
                                    <form action="../functionalities/update_func.php" method="POST">
                                        <input type="hidden" name="eveaud_ID" value="<?php echo $ID?>" />
                                        <div class="col-md-12">
                                              <label>Description:</label>
                                              <input type="text" class="form-control" name="eveaud_name" value="<?php echo $Name?>" style="width: 50%">
                                              <br>
                                              <button type="submit" name="editeveaud" class="btn btn-success" style="font-size: 15px">
                                ...
                                <div class="modal-body" style="height:180px;">
                                    <form action="../functionalities/archive_func.php" method="POST">
                                        ...
                                        <div class="col-md-12">
                                              ...
                                              <button type="submit" name="arch_eveaud" class="btn btn-success" style="font-size: 25px">
