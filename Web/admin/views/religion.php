        ...
        <aside class="right-side">
            ...
            <section class="content-header">
             ...
             <section class="content">
                                ...
                                <form class="form-horizontal" id="addRoleForm" action="../functionalities/insert_func.php" method="POST">
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <br>
                                            <div class="col-md-12">
                                                <input id="religion" name="religion" type="text" placeholder="Enter Religion" class="form-control" required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-12 text-right">
                                                <button type="submit" name="addreligion" class="btn btn-responsive btn-info btn-sm" style="font-size: 16px">
                        ...
                        <div class="panel panel-success filterable" >
                            ...
                            <div class="panel-body">
                                <table class="table table-striped table-responsive" id="table1">
                                    ...
                                    <tbody>
                                    <?php
                                        $view_query = mysqli_query($connection,"SELECT * FROM `r_religion` where rlg_stat = 1");
                ...
                <?php
                      $view_query = mysqli_query($connection,"SELECT * FROM `r_religion`");
                        while($row = mysqli_fetch_assoc($view_query))
                            {
                                $ID = $row["rlg_ID"];
                                $Name = $row["rlg_name"];
                            ...
                            <center>
                                ...
                                <div class="modal-body" style="height:160px;">
                                    <form action="../functionalities/update_func.php" method="POST">
                                        <input type="hidden" name="religion_ID" value="<?php echo $ID?>" />
                                        <div class="col-md-12">
                                              <label>Description:</label>
                                              <input type="text" class="form-control" name="religion_name" value="<?php echo $Name?>" style="width: 50%">
                                              <br>
                                              <button type="submit" name="editreligion" class="btn btn-success" style="font-size: 15px">
                                ...
                                <div class="modal-body" style="height:180px;">
                                    <form action="../functionalities/archive_func.php" method="POST">
                                        ...
                                        <div class="col-md-12">
                                              ...
                                              <button type="submit" name="arch_religion" class="btn btn-success" style="font-size: 25px">
