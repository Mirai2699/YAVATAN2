        ...
        <aside class="right-side">
            ...
            <section class="content-header">
             ...
             <section class="content">
                                ...
                                <form class="form-horizontal" id="addRoleForm" action="../functionalities/insert_func.php" method="POST">
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <br>
                                            <div class="col-md-12">
                                                <input id="region" name="region" type="text" placeholder="Enter Region" class="form-control" required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-12 text-right">
                                                <button type="submit" name="addregion" class="btn btn-responsive btn-info btn-sm" style="font-size: 16px">
                                ...
                                <table class="table table-striped table-responsive" id="table1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="70%">Region Name</th>
                                            <th width="30%">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php
                                        $view_query = mysqli_query($connection,"SELECT * FROM `r_region` WHERE rgn_stat = 1");
               ...
               <?php
                 $view_query = mysqli_query($connection,"SELECT * FROM `r_region`");
                        while($row = mysqli_fetch_assoc($view_query))
                            {
                                $ID = $row["rgn_ID"];
                                $Name = $row["rgn_name"];
                                ...
                                <div class="modal-body" style="height:160px;">
                                    <form action="../functionalities/update_func.php" method="POST">
                                        ...
                                        <div class="col-md-12">
                                              ...
                                              <input type="text" class="form-control" name="region_name" value="<?php echo $Name?>" style="width: 70%">
                                              <br>
                                              <button type="submit" name="editregion" class="btn btn-success" style="font-size: 15px">
                                ...
                                <div class="modal-body" style="height:180px;">
                                    <form action="../functionalities/archive_func.php" method="POST">
                                        ...
                                        <div class="col-md-12">
                                              ...
                                              <button type="submit" name="arch_region" class="btn btn-success" style="font-size: 25px">
