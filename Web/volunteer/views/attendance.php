                                                ...
                                                <form action="../functionalities/addattendance.php" method="POST">
                                                    <div class="form-content">
                                                        <div class="col-md-9" style="margin-bottom: 20px">
                                                            <div class="col-md-5">
                                                                <label>Event:</label>
                                                                <select name="att_eventID" class="form-control"  id="newunit" style="color: black;" required >
                                                                    <option value="" selected="" disabled=""></option>
                                                                    <?php
                                                                    $vID = $_SESSION['volun_ID'];

                                                                        $view_query = mysqli_query($connection,"SELECT * FROM `t_event` where event_status = 'PENDING' AND event_ID IN (SELECT er_eventID FROM `t_event_registration` WHERE er_volunID = '$vID')");
                                                             ...
                                                             <div class="col-md-4">
                                                                ...
                                                                <input type="date" name="att_date" class="form-control" required="" style="color: black;"  required />
                                                            </div>
                                                            <?php
                                                                    $vID = $_SESSION['volun_ID'];
                                                                    $view_query = mysqli_query($connection,"SELECT * FROM `t_volunteer` where volun_ID = '$vID' ");
                                                                            ...
                                                                            {   
                                                                               ...
                                                                               $volun_lname = $row["volun_last_Name"];
                                                                               $volun_fname = $row["volun_first_Name"];
                                                            ?>
                                                            <input type="hidden" name="att_registrar" value="<?php echo $volun_fname.' '.$volun_lname?>">
                                                            <?php } ?>
                                                        </div>
                                                     ...
                                                     <div class="form-group" style="margin-top: 20px">
                                                        <div class="col-md-12 text-right">
                                                            <button type="submit" name="addatt" class="btn btn-responsive btn-info btn-sm" style="font-size: 16px">
                        ...
                        <div class="panel panel-success filterable" >
                            ...
                            <div class="panel-body">
                                <table class="table table-striped table-responsive" id="table1">
                                    ...
                                    <?php
                                            $vID = $_SESSION['volun_ID'];
                                        $result = mysqli_query($connection,"SELECT * FROM  `t_event_attendance` AS att inner join `t_event` as                        eve on att.ev_atnd_ID = eve.event_ID WHERE event_ID IN (SELECT er_eventID FROM `t_event_registration` WHERE er_volunID = '$vID') GROUP BY eve.event_ID ");
